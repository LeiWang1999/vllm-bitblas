...
print(capability)
print(_QUANTIZATION_CONFIG_REGISTRY["marlin"].get_min_capability())
print(capability < _QUANTIZATION_CONFIG_REGISTRY["marlin"].get_min_capability())
...
if __name__ == "__main__":
    pytest.main(["-s", "tests/models/test_marlin.py"])